...
and [issue/PR templates](.github/.github/CONTRIBUTING.md#issue-and-pr-template-enforcement).

## Required Workflow (Task Start)

Follow `.github/CONTRIBUTING.md` **Required Workflow** (issue form →
`chore/<issue>-<slug>` branch → draft PR before implementation). Agents MUST
